...
```shell
docker pull nexus.mia-platform.eu/taringa-platform/image-service:latest
set -a
source .env
docker run --name image-service \
  ...
  -p 3000:3000 \
  --detach \
  nexus.mia-platform.eu/taringa-platform/image-service
```

[pipeline]: https://git.tools.mia-platform.eu/clients/taringa/taringa-platform/services/image-service/badges/master/pipeline.svg
[coverage]: https://git.tools.mia-platform.eu/clients/taringa/taringa-platform/services/image-service/badges/master/coverage.svg
[git-link]: https://git.tools.mia-platform.eu/clients/taringa/taringa-platform/services/image-service/commits/master

[nvm]: https://github.com/creationix/nvm
[merge-request]: https://git.tools.mia-platform.eu/clients/taringa/taringa-platform/services/image-service/merge_requests
